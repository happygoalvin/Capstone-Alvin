...
resource "aws_inspector_assessment_template" "alvin_capstone_assessment_template" {
  ...
  duration           = 3600
  rules_package_arns = ["arn:aws:inspector:ap-southeast-2:454640832652:rulespackage/0-D5TGAxiR", "arn:aws:inspector:ap-southeast-2:454640832652:rulespackage/0-Vkd2Vxjq", "arn:aws:inspector:ap-southeast-2:454640832652:rulespackage/0-asL6HRgN"]
